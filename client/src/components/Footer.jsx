      ...
      <div className="w-full max-w-7xl mx-auto">
        <div className="grid w-full justify-between sm:flex md:grid-cols-1">
          ...
          >
            ...
            <div>
              ...
              <Footer.LinkGroup col>
                <Footer.Link
                  href="https://www.github.com/ankit-2706/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Github
                ...
                <Footer.Link
                  href="https://linkedin.com/in/ankit-chouhan-3b5203252/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  LinkedIn
        ...
        <div className="w-full sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex gap-6 sm:mt-0 mt-4 sm:justify-center">
            ...
            />
            <Footer.Icon
              href="https://instagram.com/_ankit_27__/"
              icon={BsInstagram}
            />
            <Footer.Icon
              href="https://twitter.com/AnkitCh65977850/"
              icon={BsTwitter}
            />
            <Footer.Icon
              href="https://github.com/ankit-2706/"
              icon={BsGithub}
            />
            <Footer.Icon
              href="https://linkedin.com/in/ankit-chouhan-3b5203252/"
